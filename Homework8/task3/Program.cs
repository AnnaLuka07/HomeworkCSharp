...
// Произведение двух матриц возможно найти только в случае, если количество столбцов левой матрицы 
// совпадает с количеством строк правой. Сделаем проверку.
...
int [,] MultiplicationMatr (int [,] Matr1, int [,] Matr2)       // функция произведения матриц
{       
